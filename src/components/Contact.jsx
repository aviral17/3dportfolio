...
const Contact = () => {
  ...
  return (
    <div>
      ...
      /> */}
      <div
        className={`xl:mt-12 pb-20 flex xl:flex-row flex-col-reverse overflow-hidden justify-center items-center`}
      >
        <motion.div
          variants={slideIn("left", "tween", 0.2, 1)}
          // md:ml-[500px]
          className="relative bg-black-100 p-8  rounded-2xl mt-[147px] earthlg:ml-[28vw] w-[300px] md:w-[398px]"
        >
          <motion.img
            ref={ref}
            src={email1}
        ...
        <motion.div
          ...
          className="xl:flex-1  md:h-[459px] earthlg:h-[700px] h-[350px] p-20 earthlg:ml-[70px]"
