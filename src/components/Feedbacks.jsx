...
const FeedbackCard = ({
  ...
  const isScreenMd = window.matchMedia("(min-width: 1215px)").matches;
  ...
  return (
    <motion.div
      ...
      // whileHover={{ scale: 1.08 }} // 1.1  custom:p-5
      transition={{ type: "spring", stiffness: 70, delay: 0.1 }}
      className={`bg-black-200 pt-5 px-5 pb-10 hover:shadow-lg hover:shadow-black rounded-3xl xs:w-[320px] w-full cursor-pointer feedback-card custom:w-[300px]  h-[320px]`}
...
const Feedbacks = () => {
  ...
  return (
    <div
      ref={parentRef}
      className={`mt-12  bg-black-100 rounded-[20px] testi:h-[1050px] lg:h-[700px] group`}
    >
      {/* bg-tertiary */}
      <div
      ...
      <div
        className={`mt-5 lg:group-hover:-mt-20 transition-all duration-500 pb-14 flex items-center flex-wrap gap-16 xs:justify-center xs:items-center`}
      >
